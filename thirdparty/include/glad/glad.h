/*
    ...
    OpenGL loader generated by glad 0.1.36 on Sat Aug  3 19:00:37 2024.
    ...
    Commandline:
        --profile="core" --api="gl=4.3" --generator="c" --spec="gl" --local-files --extensions="GL_APPLE_vertex_array_object,GL_EXT_vertex_array"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D4.3&extensions=GL_APPLE_vertex_array_object&extensions=GL_EXT_vertex_array
*/
