...
//  ImTextureID! [x] Renderer: Large meshes support (64k+ vertices) with 16-bit indices (Desktop OpenGL only).
...
bool ImGui_ImplOpenGL3_Init(const char *glsl_version)
{
    ...
    printf("GlVersion = %d, \"%s\"\nGlProfileIsCompat = %d\nGlProfileMask = 0x%X\nGlProfileIsES2 = %d, GlProfileIsES3 "
           ...
           bd->GlProfileIsES3, (const char *)glGetString(GL_VENDOR), (const char *)glGetString(GL_RENDERER)); // [DEBUG]
    #endif
