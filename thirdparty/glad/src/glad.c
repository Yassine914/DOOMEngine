/*
    ...
    OpenGL loader generated by glad 0.1.36 on Sun Aug  4 17:27:56 2024.
    ...
    Commandline:
        --profile="core" --api="gl=4.3" --generator="c" --spec="gl" --extensions="GL_APPLE_vertex_array_object,GL_EXT_vertex_array"
    Online:
