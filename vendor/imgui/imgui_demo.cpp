...
// - Use the Item Picker to debug break in code by clicking any widgets:
        ...
        if(ImGui::BeginMenu("Tools"))
        {
            ...
            if(!is_debugger_present)
                ImGui::SetItemTooltip("Requires io.ConfigDebugIsDebuggerPresent=true to be set.\n\nWe otherwise "
                                      "disable the menu option to avoid casual users crashing the application.\n\nYou "
                                      "can however always access the Item Picker in Metrics->Tools.");
            ImGui::Separator();
...
static void ShowDemoWindowWidgets()
{
    ...
    if(ImGui::TreeNode("Tooltips"))
    {
        ...
        // gamepad/keyboard is being used. With default settings, ImGuiHoveredFlags_ForTooltip is equivalent to
    ...
    if(ImGui::TreeNode("Combo"))
    {
        ...
        ImGui::Combo(
            "combo 4 (function)", &item_current_4, [](void *data, int n) { return ((const char **)data)[n]; }, items,
            IM_ARRAYSIZE(items));
    ...
    if(ImGui::TreeNode("Text Input"))
    {
        ...
        if(ImGui::TreeNode("Filtered Text Input"))
        {
            ...
            static char buf6[32] = "";
            ImGui::InputText("casing swap", buf6, 32, ImGuiInputTextFlags_CallbackCharFilter,
                             TextFilters::FilterCasingSwap); // Use CharFilter callback to replace characters.
            static char buf7[32] = "";
            ImGui::InputText("\"imgui\"", buf7, 32, ImGuiInputTextFlags_CallbackCharFilter,
    ...
    if(ImGui::TreeNode("Scrolling"))
    {
        ...
        for(int i = 0; i < 5; i++)
        {
            ...
            const bool child_is_visible =
                ImGui::BeginChild(child_id, ImVec2(child_w, 200.0f), ImGuiChildFlags_Border, child_flags);
            if(ImGui::BeginMenuBar())
            {
        ...
        for(int i = 0; i < 5; i++)
        {
            ...
            bool child_is_visible =
                ImGui::BeginChild(child_id, ImVec2(-100, child_height), ImGuiChildFlags_Border, child_flags);
            if(scroll_to_off)
        ...
        ImGui::BeginChild("scrolling", scrolling_child_size, ImGuiChildFlags_Border,
    ...
    if(ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if(inputs_opened)
        {
            ...
            ImGui::Text("Mouse wheel: %.1f", io.MouseWheel);
                ...
                // allows displaying the data for old/new backends. User code should never have to go through such
                // hoops! You can generally iterate between ImGuiKey_NamedKey_BEGIN and ImGuiKey_NamedKey_END.
...
void ImGui::ShowStyleEditor(ImGuiStyle *ref)
{
    ...
    if(ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        if(ImGui::BeginTabItem("Sizes"))
        {
            ...
            ImGui::SliderFloat2("TableAngledHeadersTextAlign", (float *)&style.TableAngledHeadersTextAlign, 0.0f, 1.0f,
                                "%.2f");
